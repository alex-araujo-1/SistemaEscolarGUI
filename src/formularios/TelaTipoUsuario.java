...
public class TelaTipoUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PARA CONTINUAR O CADASTRO INFORME QUEM SERÁ O USÚARIO DO SISTEMA");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "TIPO DE USUÁRIO", "Aluno", "Professor", "Financeiro", "Gestor", " " }));
    ...
    private void btnContinuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContinuarActionPerformed
        dispose();
        TelaDadosAluno da = new TelaDadosAluno();
        da.setVisible(true);
